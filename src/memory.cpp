...
uint8_t read_io(const Gameboy& gb, const uint16_t address)
{
	...
	case 0xFF10: return gb.apu.ch1.nr10.value;
	case 0xFF11: return gb.apu.ch1.nr11.value;
	case 0xFF12: return gb.apu.ch1.nr12.value;
	case 0xFF13: return gb.apu.ch1.nr13.value;
	case 0xFF14: return gb.apu.ch1.nr14.value;
	case 0xFF16: return gb.apu.ch2.nr21.value;
	case 0xFF17: return gb.apu.ch2.nr22.value;
	case 0xFF18: return gb.apu.ch2.nr23.value;
	case 0xFF19: return gb.apu.ch2.nr24.value;
	case 0xFF1A: return gb.apu.ch3.nr30.value;
	case 0xFF1B: return gb.apu.ch3.nr31.value;
	case 0xFF1C: return gb.apu.ch3.nr32.value;
	case 0xFF1D: return gb.apu.ch3.nr33.value;
	case 0xFF1E: return gb.apu.ch3.nr34.value;
	case 0xFF20: return gb.apu.ch4.nr41.value;
	case 0xFF21: return gb.apu.ch4.nr42.value;
	case 0xFF22: return gb.apu.ch4.nr43.value;
	case 0xFF23: return gb.apu.ch4.nr44.value;
	case 0xFF24: return gb.apu.ctl.nr50.value;
	case 0xFF25: return gb.apu.ctl.nr51.value;
	case 0xFF26: return gb.apu.ctl.nr52.value;
...
void write_io(const uint16_t address, const uint8_t value, Gameboy* const gb)
{
	...
	case 0xFF10: gb->apu.ch1.nr10.value = value; break;
	case 0xFF11: gb->apu.ch1.nr11.value = value; break;
	case 0xFF12: gb->apu.ch1.nr12.value = value; break;
	case 0xFF13: gb->apu.ch1.nr13.value = value; break;
	case 0xFF14: gb->apu.ch1.nr14.value = value; break;
	case 0xFF16: gb->apu.ch2.nr21.value = value; break;
	case 0xFF17: gb->apu.ch2.nr22.value = value; break;
	case 0xFF18: gb->apu.ch2.nr23.value = value; break;
	case 0xFF19: gb->apu.ch2.nr24.value = value; break;
	case 0xFF1A: gb->apu.ch3.nr30.value = value; break;
	case 0xFF1B: gb->apu.ch3.nr31.value = value; break;
	case 0xFF1C: gb->apu.ch3.nr32.value = value; break;
	case 0xFF1D: gb->apu.ch3.nr33.value = value; break;
	case 0xFF1E: gb->apu.ch3.nr34.value = value; break;
	case 0xFF20: gb->apu.ch4.nr41.value = value; break;
	case 0xFF21: gb->apu.ch4.nr42.value = value; break;
	case 0xFF22: gb->apu.ch4.nr43.value = value; break;
	case 0xFF23: gb->apu.ch4.nr44.value = value; break;
	case 0xFF24: gb->apu.ctl.nr50.value = value; break;
	case 0xFF25: gb->apu.ctl.nr51.value = value; break;
	case 0xFF26: gb->apu.ctl.nr52.value = value; break;
	case 0xFF30: // [[fallthrough]]
	case 0xFF31: // [[fallthrough]]
	case 0xFF32: // [[fallthrough]]
	case 0xFF33: // [[fallthrough]]
